...
public class UserProfileServiceImpl implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) {
		Optional<UserProfile> optionalProfile = profileRepository.findByUsername(username);
		UserProfile userProfile = optionalProfile.orElseThrow(() -> new UsernameNotFoundException(""));
